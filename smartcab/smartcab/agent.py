...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing:
            ...
            #implement epsilonT+a = eplsilonT-0.05
            #self.epsilon = self.epsilon - 0.005
            self.epsilon = self.epsilon * 0.87
    ...
    def build_state(self):
        ...
        #state = None
        #('build waypoint >>>', 'left') , right or forward
        ...
        #side_traffic_in_direction_oncoming = inputs['left'] == inputs['oncoming'] or inputs['right'] == inputs[
        #    'oncoming'] or inputs['oncoming'] is not None
        state = (waypoint, inputs['light'], inputs['oncoming'], inputs['left'])

        print ("ceated state >>>", state)
        #return tuple(state)
    ...
    def choose_action(self, state):
        ...
        #       if self.get_maxQ(state) == self.Q[state][i]:
        #           ties.append(i)
        ...
        if self.learning:
            ...
            #global maxPolicy
            if (action_with_max_Q < self.maxPolicy):
                self.maxPolicy = action_with_max_Q
...
def run():
    ...
    sim.run(n_test=300, tolerance =0.001)
    print ("max reward",agent.maxPolicy)
    print("Version 1.000005")
    #sim.run()
